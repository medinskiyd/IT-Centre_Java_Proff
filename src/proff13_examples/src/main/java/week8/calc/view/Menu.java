package week8.calc.view;

import week8.calc.service.OperationService;
...
public class Menu {
    ...
    public Menu(OperationService operationService) {
...
//        for (сlient user : operationService.getAllUsers()) {
...
//        operationService.addNewUser(user);
    }
